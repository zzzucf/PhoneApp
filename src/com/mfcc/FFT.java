...
public final class FFT
{
	...
	public float[] calculateFFTMagnitude(float x[])
	{
		...
		if (x.length > n)
		{
			throw new Error("Tried to use a " + n + "-points FFT for a vector with " + x.length + " samples!");
		}
	...
	public double[] calculateFFTMagnitude(double inputData[])
	{
		...
		{
			throw new Error("Tried to use a " + n + "-points FFT for a vector with " + inputData.length + " samples!");
		}
