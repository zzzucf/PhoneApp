	...
	private final void expandSearchWindow(int radius)
	{
						...
						// current search window
		{
			...
			for (int cell = 0; cell < windowCells.size(); cell++)
			{
				...
				if ((currentCell.getCol() != minI()) && (currentCell.getRow() != maxJ()))// move
																							// to
																							// upper
																							// left
																							// if
				...
				if ((currentCell.getCol() != maxI()) && (currentCell.getRow() != maxJ())) // move
																							// to
																							// upper-right
																							// if
																							// possible
				...
				if ((currentCell.getCol() != minI()) && (currentCell.getRow() != minJ())) // move
																							// to
																							// lower-left
																							// if
																							// possible
				...
				if ((currentCell.getCol() != maxI()) && (currentCell.getRow() != minJ())) // move
																							// to
																							// lower-right
																							// if
																							// possible
